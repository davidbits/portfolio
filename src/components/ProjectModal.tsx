		...
		>
			...
			>
				...
				<div className="space-y-6 text-gray-700">
					<div>
						<h3 className="mb-2 font-bold text-gray-900">Overview</h3>
						<p className="leading-relaxed">{project.overview}</p>
					</div>

					{project.objectives && (
						<div>
							<h3 className="mb-2 font-bold text-gray-900">Key Objectives</h3>
					...
					{project.challenges && (
						<div>
							<h3 className="mb-2 font-bold text-gray-900">Challenges</h3>
					...
					{project.results && (
						<div>
							<h3 className="mb-2 font-bold text-gray-900">Results</h3>
