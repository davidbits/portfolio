	...
	<Document>
		<Page size="A4" style={styles.page}>
			...
			<View style={styles.section}>
				...
				{EXPERIENCE.map((job) => (
					<View key={job.company} style={styles.item}>
						...
						<Text style={{ fontSize: 9, marginBottom: 4, color: "#444" }}>
							{job.description}
						</Text>
						{job.details.map((detail) => (
							<View key={detail} style={styles.bulletPoint}>
								<Text style={styles.bullet}>•</Text>
								<Text style={styles.bulletContent}>{detail}</Text>
							</View>
						))}
					</View>
				))}
			...
			<View style={styles.section}>
				...
				{EDUCATION.map((edu) => (
					<View key={edu.degree} style={styles.item}>
						<View style={styles.itemHeader}>
							<View>
			...
			<View style={styles.section}>
				...
				{INTERESTS.map((interest) => (
					<View key={interest.title} style={styles.item}>
